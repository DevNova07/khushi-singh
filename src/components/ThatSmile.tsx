    ...
    <section id="chapter-02" className="relative w-full pt-0 pb-4 px-3 sm:px-4">
      <div className="max-w-md sm:max-w-lg w-full mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <span>Chapter 02 • The Radiance</span>
        </motion.div>
        ...
        >
          That smile... <span className="text-[#E91E63] inline-block animate-heartbeat">❤️</span>
        </motion.h2>
        ...
        >
          <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-pink-50">
            <img
              ...
              alt="Khushi Singh - That Smile"
              className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-1000 ease-out"
              loading="eager"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
            <div className="absolute bottom-4 left-4 right-4 text-white text-center">
              <span className="text-xs font-mono tracking-widest text-[#FCE7EF] uppercase">Pure Radiance</span>
              <p className="font-serif-luxury text-xl font-bold">Khushi's Smile</p>
            </div>
          </div>
        </motion.div>
