...
export const BeautifulSoul: React.FC = () => {
  return (
    <section id="chapter-03" className="relative w-full pt-0 pb-4 px-3 sm:px-4">
      <div className="max-w-md sm:max-w-lg w-full mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <span>Chapter 03 • Serenity & Grace</span>
        </motion.div>
        ...
        >
          That beautiful soul... <span className="text-[#D6A85F] inline-block">✨</span>
        </motion.h2>
        ...
        >
          "Calm like the lake water, pure and gentle. A soul that brings peace wherever you go."
        </motion.p>
        ...
        <motion.div
          ...
          className="relative group p-3 sm:p-4 rounded-3xl glass-panel-deep shadow-2xl glow-gold w-full mx-auto"
        >
          <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-pink-50">
            <img
              src="/photos/photo3_lake.jpg"
              alt="Khushi Singh - Beautiful Soul"
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white text-center">
              <span className="text-xs font-mono tracking-widest text-[#D6A85F] uppercase">Serene & Pure</span>
              <p className="font-serif-luxury text-xl font-bold">Khushi's Grace</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p className="text-xs sm:text-sm font-serif-luxury italic text-[#8A6875]">
            "Aapki saadgi aur aapka mann sabse pyaara hai."
          </p>
        </motion.div>
